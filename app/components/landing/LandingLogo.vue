<template>
	<NuxtLink to="/" class="text-primary hover:text-highlighted flex items-end gap-1 transition-colors">
		<svg class="size-8 shrink-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 81.3 85.88" aria-hidden="true">
			<path
				fill="currentColor"
		...
		<span class="text-[28px] leading-none font-bold tracking-normal">SHADOWCRYPT</span>
	</NuxtLink>
</template>
